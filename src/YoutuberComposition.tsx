...
export const TopYoutubersComposition: React.FC<TopYoutubersProps> = ({
  spacing,
  pedestalHeight,
  cameraHeight,
  cameraDistance,
  ...
  // Same space transition logic — top 5 → top 3
