...
export type TopAICompaniesProps = {
  spacing: number;
...
export const TopAICompaniesComposition: React.FC<TopAICompaniesProps> = ({
  spacing,
  pedestalHeight,
  cameraHeight,
  cameraDistance,
  ...
  const spaceProgress = interpolate(frame, [1260, 1620], [0, 1], {
